...
indir <- paste0(output_data, "/tracking/AGAZ", "/L2_locations")
outdir <- paste0(output_data, "/tracking/AGAZ", "/L2_simulations")

# For CPF simulations in FS
outdir <- paste0(output_data, "/tracking/AGAZ", "/L2_simulations_FScpf")
